  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] flex items-center justify-center px-4">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-violet-600/10 rounded-full blur-3xl"></div>
      </div>
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="card-dark rounded-2xl p-8">
          ...
          <div className="space-y-3 mb-6">
            ...
            <button
              onClick={handleApple}
              className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl bg-black border border-[#333] text-white hover:border-violet-500/50 hover:bg-[#0d0d0d] transition-all text-sm font-medium"
            >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-blue-500 hover:from-violet-500 hover:to-blue-400 text-white font-semibold text-sm transition-all disabled:opacity-60 disabled:cursor-not-allowed mt-6"
            >
          ...
          <p className="text-center text-sm text-gray-500 mt-6">
            ...
            <Link href="/auth/inscription" className="text-violet-400 hover:text-violet-300 font-medium transition-colors">
              S&apos;inscrire
            </Link>
          </p>
        </div>
